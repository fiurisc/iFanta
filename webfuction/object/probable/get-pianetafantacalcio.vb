Partial Class WebData
    Partial Class ProbableFormations
        ...
        Function GetPianetaFantacalcio(ServerPath As String, ReturnData As Boolean) As String
            ...
            Try
                ...
                Dim html As String = GetPage("https://www.pianetafanta.it/probabili-formazioni-complete-serie-a-live.asp", "POST", "")
                    ...
                    For i As Integer = 0 To line.Length - 1
                        ...
                        If line(i) <> "" Then
                            ...
                            ElseIf line(i).Contains("<h2 class=""TeamNome"">") Then
                                sq.Add(CheckTeamName(System.Text.RegularExpressions.Regex.Match(line(i), "(?<=\>)\w+(?=\<\/h)").Value.ToUpper()))
                            ...
                            ElseIf line(i).Contains("<div class=""giocatori-indisponibili"">") Then
                                ...
                                Dim info As String = NormalizeText(System.Text.RegularExpressions.Regex.Match(line(i + 2), "(?<=strong\>).*(?=\<\/div\>)").Value.Trim)
                                ...
                                If name <> "" Then
                                    pstate = "Infortunato"
                                    name = ResolveName("", name, team, wpl, False).GetName()
                                    Call AddInfo(name, team, site, pstate, info, -1, wpd)
                                End If
                            ...
                            ElseIf line(i).Contains("<div class=""giocatori-squalificati"">") Then
                                ...
                                Dim info As String = NormalizeText(System.Text.RegularExpressions.Regex.Match(line(i + 3), ".*(?=\<\/div\>)").Value.Trim.Replace("(", "").Replace(")", ""))
