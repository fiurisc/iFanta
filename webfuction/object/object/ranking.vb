Partial Class WebData
    ...
    Function GetRanking(ServerPath As String, ReturnData As Boolean) As String
        ...
        Try
            ...
            Dim html As String = GetPage("http://www.gazzetta.it/calcio/serie-a/classifica/", "POST", "")
            ...
            If ReturnData Then
                Return "</br><span style=color:red;font-size:bold;'>Ranking (" & year & "):</span></br>" & strdata.ToString.Replace(System.Environment.NewLine, "</br>") & "</br>"
            Else
                Return ("</br><span style=color:red;font-size:bold;'>Ranking (" & year & "):</span><span style=color:blue;font-size:bold;'>Compleated!!</span></br>")
            End If
