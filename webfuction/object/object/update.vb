Public Class UpdateList
    ...
    Private _PathL As String = System.Web.HttpContext.Current.Server.MapPath("/public/ifanta/update")
    Private _PathR As String = System.Web.HttpContext.Current.Server.MapPath("/public/ifanta/update")
