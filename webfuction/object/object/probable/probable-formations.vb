Partial Class WebData
    Public Class ProbableFormations
        ...
        Sub AddInfo(Name As String, Team As String, Site As String, State As String, Info As String, Percentage As Integer, wp As Dictionary(Of String, wPlayer))
        ...
        Function WriteData(wp As Dictionary(Of String, wPlayer), filed As String) As String
        ...
        Function WriteData(day As Integer, wp As Dictionary(Of String, wPlayer), filed As String) As String
