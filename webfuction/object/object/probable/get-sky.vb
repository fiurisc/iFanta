Partial Class WebData
    Partial Class ProbableFormations
        ...
        Function GetSky(ServerPath As String, ReturnData As Boolean) As String
            ...
            Try
                ...
                Dim html As String = GetPage("https://sport.sky.it/calcio/serie-a/probabili-formazioni", "POST", "")
                            ...
                            If line.Contains("<span class=""name"">") Then
                                ...
                                Select Case sez
                                    Case "header"
                                        ...
                                        sq.Add(CheckTeamName(val.ToUpper))
