Partial Class WebData
    Partial Class ProbableFormations
        ...
        Function GetFantacalcio(ServerPath As String, ReturnData As Boolean) As String
            ...
            Try
                ...
                Dim html As String = GetPage("https://www.fantacalcio.it/probabili-formazioni-serie-A", "POST", "")
                    ...
                    For i As Integer = 0 To lines.Length - 1
                        ...
                        If line <> "" Then
                            ...
                            If pstate <> "" AndAlso line.Contains("href=""https://www.fantacalcio.it/serie-a/squadre/") AndAlso lines(i + 2).Contains("</span>") Then
                                team = CheckTeamName(System.Text.RegularExpressions.Regex.Match(lines(i), "(?<=www\.fantacalcio\.it\/serie\-a\/squadre\/)\w+(?=\/)").Value.ToUpper())
                                ...
                                ElseIf pstate = "Infortunato" Then
                                    info = NormalizeText(lines(i + 5).Trim())
                                End If
