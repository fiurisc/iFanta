Namespace Torneo
    Partial Class TorneoSettings
        Public Class CoppaSettings
            ...
            Public Property QuartiDiFinale1Team() As Integer() = New Integer() {-1, -1}
            Public Property QuartiDiFinale2Team() As Integer() = New Integer() {-1, -1}
            Public Property QuartiDiFinale3Team() As Integer() = New Integer() {-1, -1}
            Public Property QuartiDiFinale4Team() As Integer() = New Integer() {-1, -1}
