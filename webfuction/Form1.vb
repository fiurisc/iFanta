...
Public Class Form1
    ...
    Private Sub Button4_Click(sender As Object, e As EventArgs) Handles Button4.Click
        ...
        Dim dclasa As New Torneo.ClassificaData(appSett)
        dclasa.ApiGetStoricoClassifica(False)
    End Sub
    ...
    Private Sub cmdcoppa_Click(sender As Object, e As EventArgs) Handles cmdcoppa.Click
        ...
        Console.WriteLine(pdata.ApiGetCoppa())
    End Sub
    ...
    Private Sub GetAutomaticFormation()
        ...
        Dim fileLog1 As String = appSett.WebDataPath & "temp\autoformaresult1.log"
        Dim fileLog2 As String = appSett.WebDataPath & "temp\autoformaresult2.log"
        Dim fileLog3 As String = appSett.WebDataPath & "temp\autoformaresult3.log"
        Dim fileLog4 As String = appSett.WebDataPath & "temp\autoformaresult4.log"
        ...
        For g As Integer = 1 To 2
            ...
            Try
                ...
                If dicResult.ContainsKey(-1) Then
                    Debug.WriteLine("Punteggi giornata: " & g & " pt:" & dicResult(-1).Formazione.Punti / 10)
                Else
                    ...
                    If lstUser.Count > 0 AndAlso lstTop.Count = lstUser.Count Then
                        ...
                        sout.Insert(0, "Punteggi giornata: " & g & " diff:" & difftot & Environment.NewLine)

                        sr1.WriteLine(sout.ToString())
    ...
    Private Sub Button16_Click(sender As Object, e As EventArgs) Handles Button16.Click
        Dim prob As New WebData.ProbableFormations(appSett)
        prob.GetProbableFormation("", False, 2)
    End Sub

    Private Sub Button17_Click(sender As Object, e As EventArgs) Handles Button17.Click
        Dim prob As New WebData.ProbableFormations(appSett)
        For i As Integer = 31 To 38
            prob.GetProbableFormation("pianetafantacalcio", False, i)
        Next

    End Sub

    Private Sub Button18_Click(sender As Object, e As EventArgs) Handles Button18.Click
        'Dim prob As New WebData.PlayersRanking(appSett)
        'For i As Integer = 22 To 38
        '    prob.GetPlayersRankingData(False, i)
        'Next
        Dim json As String = "{""type"":""rose"",""teamId"":5,""data"":{""5"":{""icon"":""http://127.0.0.1:5500/public/tornei/Parenti/2026/stemmi/T5.png"",""name"":""Squadra 6"",""coach"":""Loris Dall'omo"",""players"":[{""TeamId"":5,""RosaId"":0,""Nome"":"""",""Squadra"":"""",""Ruolo"":""P"",""RuoloMantraS"":""P"",""Riconfermato"":0,""Nat"":"""",""NatCode"":"""",""Compleanno"":"""",""Anni"":"""",""Altezza"":"""",""Peso"":"""",""Costo"":""0"",""Qini"":""0"",""Qcur"":0,""RuoloMantra"":""P"",""OutOfGame"":0,""Variation"":0,""Rating"":0,""Tag"":"""",""rank"":0},{""TeamId"":5,""RosaId"":1,""Nome"":"""",""Squadra"":"""",""Ruolo"":""P"",""RuoloMantraS"":""P"",""Riconfermato"":0,""Nat"":"""",""NatCode"":"""",""Compleanno"":"""",""Anni"":"""",""Altezza"":"""",""Peso"":"""",""Costo"":""0"",""Qini"":""0"",""Qcur"":0,""RuoloMantra"":""P"",""OutOfGame"":0,""Variation"":0,""Rating"":0,""Tag"":"""",""rank"":0},{""TeamId"":5,""RosaId"":2,""Nome"":"""",""Squadra"":"""",""Ruolo"":""P"",""RuoloMantraS"":""P"",""Riconfermato"":0,""Nat"":"""",""NatCode"":"""",""Compleanno"":"""",""Anni"":"""",""Altezza"":"""",""Peso"":"""",""Costo"":""0"",""Qini"":""0"",""Qcur"":0,""RuoloMantra"":""P"",""OutOfGame"":0,""Variation"":0,""Rating"":0,""Tag"":"
"""",""NatCode"":"""",""Compleanno"":"""",""Anni"":"""",""Altezza"":"""",""Peso"":"""",""Costo"":""0"",""Qini"":""0"",""Qcur"":0,""RuoloMantra"":""P"",""OutOfGame"":0,""Variation"":0,""Rating"":0,""Tag"":"""",""rank"":0},{""TeamId"":5,""RosaId"":11,""Nome"":"""",""Squadra"":"""",""Ruolo"":""C"",""RuoloMantraS"":""P"",""Riconfermato"":0,""Nat"":"""",""NatCode"":"""",""Compleanno"":"""",""Anni"":"""",""Altezza"":"""",""Peso"":"""",""Costo"":""0"",""Qini"":""0"",""Qcur"":0,""RuoloMantra"":""P"",""OutOfGame"":0,""Variation"":0,""Rating"":0,""Tag"":"""",""rank"":0},{""TeamId"":5,""RosaId"":12,""Nome"":"""",""Squadra"":"""",""Ruolo"":""C"",""RuoloMantraS"":""P"",""Riconfermato"":0,""Nat"":"""",""NatCode"":"""",""Compleanno"":"""",""Anni"":"""",""Altezza"":"""",""Peso"":"""",""Costo"":""0"",""Qini"":""0"",""Qcur"":0,""RuoloMantra"":""P"",""OutOfGame"":0,""Variation"":0,""Rating"":0,""Tag"":"""",""rank"":0},{""TeamId"":5,""RosaId"":13,""Nome"":"""",""Squadra"":"""",""Ruolo"":""C"",""RuoloMantraS"":""P"",""Riconfermato"":0,""Nat"":"""",""NatCode"":"""",""Compleanno"":"""",""Anni"":"""",""Altezza"":"""",""Peso"":"""",""Costo"":""0"",""Qini"":""0"",""Qcur"":0,""RuoloMantra"":""P"",""OutOfGame"":0,""Variation"":0,""Rating"":0,""Tag"":"""",""rank"":0},{""TeamId"":5,""RosaId"":14,""Nome"":"""",""Squadra"":"""",""Ruolo"":""C"",""RuoloMantraS"":""P"",""Riconfermato"":0,""Nat"":"""",""NatCode"":"""",""Compleanno"":"""",""Anni"":"""",""Altezza"":"""",""Peso"":"""",""Costo"":""0"",""Qini"":""0"",""Qcur"":0,""RuoloMantra"":""P"",""OutOfGame"":0,""Variation"":0,""Rating"":0,""Tag"":"""",""rank"":0},{""TeamId"":5,""RosaId"":15,""Nome"":"""",""Squadra"":"""",""Ruolo"":""C"",""RuoloMantraS"":""P"",""Riconfermato"":0,""Nat"":"""",""NatCode"":"""",""Compleanno"":"""",""Anni"":"""",""Altezza"":"""",""Peso"":"""",""Costo"":""0"",""Qini"":""0"",""Qcur"":0,""RuoloMantra"":""P"",""OutOfGame"":0,""Variation"":0,""Rating"":0,""Tag"":"""",""rank"":0},{""TeamId"":5,""RosaId"":16,""Nome"":"""",""Squadra"":"""",""Ruolo"":""C"",""RuoloMantraS"":""P"",""Riconfermato"":0,""Nat"":"""",""NatCode"":"""",""Compleanno"":"""",""Anni"":"""",""Altezza"":"""",""Peso"":"""",""Costo"":""0"",""Qini"":""0"",""Qcur"":0,""RuoloMantra"":""P"",""OutOfGame"":0,""Variation"":0,""Rating"":0,""Tag"":"""",""rank"":0},{""TeamId"":5,""RosaId"":17,""Nome"":"""",""Squadra"":"""",""Ruolo"":""C"",""RuoloMantraS"":""P"",""Riconfermato"":0,""Nat"":"""",""NatCode"":"""",""Compleanno"":"""",""Anni"":"""",""Altezza"":"""",""Peso"":"""",""Costo"":""0"",""Qini"":""0"",""Qcur"":0,""RuoloMantra"":""P"",""OutOfGame"":0,""Variation"":0,""Rating"":0,""Tag"":"""",""rank"":0},{""TeamId"":5,""RosaId"":18,""Nome"":"""",""Squadra"":"""",""Ruolo"":""C"",""RuoloMantraS"":""P"",""Riconfermato"":0,""Nat"":"""",""NatCode"":"""",""Compleanno"":"""",""Anni"":"""",""Altezza"":"""",""Peso"":"""",""Costo"":""0"",""Qini"":""0"",""Qcur"":0,""RuoloMantra"":""P"",""OutOfGame"":0,""Variation"":0,""Rating"":0,""Tag"":"""",""rank"":0},{""TeamId"":5,""RosaId"":19,""Nome"":"""",""Squadra"":"""",""Ruolo"":""A"",""RuoloMantraS"":""P"",""Riconfermato"":0,""Nat"":"""",""NatCode"":"""",""Compleanno"":"""",""Anni"":"""",""Altezza"":"""",""Peso"":"""",""Costo"":""0"",""Qini"":""0"",""Qcur"":0,""RuoloMantra"":""P"",""OutOfGame"":0,""Variation"":0,""Rating"":0,""Tag"":"""",""rank"":0},{""TeamId"":5,""RosaId"":20,""Nome"":"""",""Squadra"":"""",""Ruolo"":""A"",""RuoloMantraS"":""P"",""Riconfermato"":0,""Nat"":"""",""NatCode"":"""",""Compleanno"":"""",""Anni"":"""",""Altezza"":"""",""Peso"":"""",""Costo"":""0"",""Qini"":""0"",""Qcur"":0,""RuoloMantra"":""P"",""OutOfGame"":0,""Variation"":0,""Rating"":0,""Tag"":"""",""rank"":0},{""TeamId"":5,""RosaId"":21,""Nome"":"""",""Squadra"":"""",""Ruolo"":""A"",""RuoloMantraS"":""P"",""Riconfermato"":0,""Nat"":"""",""NatCode"":"""",""Compleanno"":"""",""Anni"":"""",""Altezza"":"""",""Peso"":"""",""Costo"":""0"",""Qini"":""0"",""Qcur"":0,""RuoloMantra"":""P"",""OutOfGame"":0,""Variation"":0,""Rating"":0,""Tag"":"""",""rank"":0},{""TeamId"":5,""RosaId"":22,""Nome"":"""",""Squadra"":"""",""Ruolo"":""A"",""RuoloMantraS"":""P"",""Riconfermato"":0,""Nat"":"""",""NatCode"":"""",""Compleanno"":"""",""Anni"":"""",""Altezza"":"""",""Peso"":"""",""Costo"":""0"",""Qini"":""0"",""Qcur"":0,""RuoloMantra"":""P"",""OutOfGame"":0,""Variation"":0,""Rating"":0,""Tag"":"""",""rank"":0},{""TeamId"":5,""RosaId"":23,""Nome"":"""",""Squadra"":"""",""Ruolo"":""A"",""RuoloMantraS"":""P"",""Riconfermato"":0,""Nat"":"""",""NatCode"":"""",""Compleanno"":"""",""Anni"":"""",""Altezza"":"""",""Peso"":"""",""Costo"":""0"",""Qini"":""0"",""Qcur"":0,""RuoloMantra"":""P"",""OutOfGame"":0,""Variation"":0,""Rating"":0,""Tag"":"""",""rank"":0},{""TeamId"":5,""RosaId"":24,""Nome"":"""",""Squadra"":"""",""Ruolo"":""A"",""RuoloMantraS"":""P"",""Riconfermato"":0,""Nat"":"""",""NatCode"":"""",""Compleanno"":"""",""Anni"":"""",""Altezza"":"""",""Peso"":"""",""Costo"":""0"",""Qini"":""0"",""Qcur"":0,""RuoloMantra"":""P"",""OutOfGame"":0,""Variation"":0,""Rating"":0,""Tag"":"""",""rank"":0}]}}}"

        Dim r As New Torneo.RoseData(appSett)
        r.ApiAddRosa("5", json)
