...
Module Module1
    ...
    Private _flog As String = My.Application.Info.DirectoryPath & "\update.log"
    ...
    Public Sub DeleteAppLog()
        Try
            If IO.File.Exists(_flog) Then IO.File.Delete(_flog)
        Catch ex As Exception

        End Try
    End Sub

    Public Sub WriteOnLog(Message As String)
        Try
            IO.File.AppendAllText(_flog, Message & System.Environment.NewLine)
        Catch ex As Exception
