...
#Region "Function"
    ...
    Private Sub Draw()
        ...
        If _resume = False OrElse _SuspendLayout = True OrElse Me.Width = 0 OrElse Me.Height = 0 Then Exit Sub
...
#Region "Event on control"
    ...
    Private Sub iProgressBar_Load(sender As Object, e As EventArgs) Handles MyBase.Load
